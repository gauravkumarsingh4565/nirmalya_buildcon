...
export default function Contact() {
  ...
  return (
    <>
      <SEO 
        title="Contact Us | Nirmalya Buildcon Pvt Ltd" 
        description="Get in touch with Nirmalya Buildcon. Visit our corporate office or reach out via phone/email for inquiries about residential and commercial projects."
        url="/contact"
      />
